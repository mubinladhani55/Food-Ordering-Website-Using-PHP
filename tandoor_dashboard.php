...
// Define tandoor restaurant names
$tandoorRestaurants = ['Tandoor Restaurant'];
$tandoorRestaurantsString = "'" . implode("','", $tandoorRestaurants) . "'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_status'])) {
    ...
    $update_sql = "UPDATE restaurant_orders SET status = '$new_status' 
                  ...
                  AND restaurant IN ($tandoorRestaurantsString)";
...
$total_orders_query = "SELECT COUNT(DISTINCT order_id) as count, SUM(price * quantity) as revenue 
                      ...
                      WHERE restaurant IN ($tandoorRestaurantsString)";
...
$pending_orders_query = "SELECT COUNT(DISTINCT order_id) as count 
                        FROM restaurant_orders 
                        WHERE restaurant IN ($tandoorRestaurantsString) AND status = 'pending'";
...
$completed_orders_query = "SELECT COUNT(DISTINCT order_id) as count 
                          FROM restaurant_orders 
                          WHERE restaurant IN ($tandoorRestaurantsString) AND status = 'completed'";
...
$where_clause = "WHERE restaurant IN ($tandoorRestaurantsString)";
...
function getOrderDetails($conn, $order_id, $tandoorRestaurantsString) {
...
<head>
    ...
    <title>Tandoor Dashboard - Foodie Express</title>
    ...
    <style>
        ...
        .active-filter { background-color: #e85a27 !important; border-color: #e85a27 !important; }
        .pagination .page-item.active .page-link { background-color: #e85a27; border-color: #e85a27; }
        .pagination .page-link { color: #e85a27; }
        .btn-primary { background-color: #e85a27; border-color: #e85a27; }
        .btn-primary:hover { background-color: #d84315; border-color: #d84315; }
        .btn-outline-primary { color: #e85a27; border-color: #e85a27; }
        .btn-outline-primary:hover { background-color: #e85a27; border-color: #e85a27; color: white; }
        .navbar-brand { color: #e85a27 !important; }
    </style>
</head>
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="tandoor_dashboard.php">
                <i class="fas fa-fire"></i> Tandoor Dashboard - Foodie Express
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="tandoor_dashboard.php">
                            <i class="fas fa-tachometer-alt me-1"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tandoor_menu.php">
                            <i class="fas fa-utensils me-1"></i> Tandoor Menu
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <div class="dashboard-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2><i class="fas fa-fire me-2"></i><?php echo htmlspecialchars($restaurant_name); ?> Tandoor Dashboard</h2>
                    <p class="text-muted">Tandoor orders summary and management</p>
                </div>
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="stats-card text-center">
                    <i class="fas fa-fire fa-3x mb-3 text-primary"></i>
                    <h3><?php echo $total_orders; ?></h3>
                    <p class="text-muted mb-0">Total Tandoor Orders</p>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card text-center">
            ...
            <div class="col-md-3 mb-3">
                <div class="stats-card text-center">
                    ...
                    <p class="text-muted mb-0">Tandoor Revenue</p>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-header bg-white">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h4 class="mb-0"><i class="fas fa-fire me-2"></i>Tandoor Order Management</h4>
                    </div>
            ...
            <div class="card-body">
                <?php if (mysqli_num_rows($distinct_orders_result) > 0): ?>
                    <?php while ($order_row = mysqli_fetch_assoc($distinct_orders_result)): ?>
                        <?php 
                            ...
                            $order_items = getOrderDetails($conn, $order_id, $tandoorRestaurantsString);
                        ...
                        <div class="order-card">
                            <div class="order-header">
                                <div class="row align-items-center">
                                    <div class="col-md-4">
                                        <h5 class="mb-1">Tandoor Order #<?php echo htmlspecialchars($order_id); ?></h5>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Update Tandoor Order Status</h5>
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        <img src="https://cdn-icons-png.flaticon.com/512/2082/2082063.png" alt="No Tandoor Orders" style="width: 80px; opacity: 0.5;" class="mb-3">
                        <h4>No Tandoor Orders Found</h4>
                        <p class="text-muted">There are no tandoor orders matching your filter criteria.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="modal fade" id="settingsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tandoor Dashboard Settings</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="">
                    <div class="modal-body">
