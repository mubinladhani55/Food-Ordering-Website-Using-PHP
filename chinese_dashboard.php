...
// Define the exact Chinese restaurant name
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_status'])) {
    ...
    $update_sql = "UPDATE restaurant_orders SET status = '$new_status' 
                  ...
                  AND restaurant = '$chineseRestaurant'";
...
$default_status = isset($_SESSION['default_status']) ? $_SESSION['default_status'] : 'pending';
...
$total_orders_query = "SELECT COUNT(DISTINCT order_id) as count, SUM(price * quantity) as revenue 
                      ...
                      WHERE restaurant = '$chineseRestaurant'";
...
$pending_orders_query = "SELECT COUNT(DISTINCT order_id) as count 
                        FROM restaurant_orders 
                        WHERE restaurant = '$chineseRestaurant' AND status = 'pending'";
...
$completed_orders_query = "SELECT COUNT(DISTINCT order_id) as count 
                          FROM restaurant_orders 
                          WHERE restaurant = '$chineseRestaurant' AND status = 'completed'";
...
// Build WHERE clause
$where_clause = "WHERE restaurant = '$chineseRestaurant'";
...
// Get distinct order IDs with their current status for the current page
$orders_sql = "SELECT 
                  order_id, 
                  MAX(created_at) as created_at,
                  (SELECT status FROM restaurant_orders WHERE order_id = ro.order_id LIMIT 1) as status
...
// Function to get order details with current status
function getOrderDetails($conn, $order_id, $chineseRestaurant) {
...
<head>
    ...
    <title>Chinese Dashboard - Foodie Express</title>
    ...
    <style>
        ...
        .active-filter { background-color: #d4af37 !important; border-color: #d4af37 !important; color: white !important; }
        .pagination .page-item.active .page-link { background-color: #d4af37; border-color: #d4af37; }
        .pagination .page-link { color: #d4af37; }
        .btn-primary { background-color: #d4af37; border-color: #d4af37; }
        .btn-primary:hover { background-color: #c9a227; border-color: #c9a227; }
        .btn-outline-primary { color: #d4af37; border-color: #d4af37; }
        .btn-outline-primary:hover { background-color: #d4af37; border-color: #d4af37; color: white; }
        .navbar-brand { color: #d4af37 !important; }
        .navbar { background-color: #8b0000 !important; }
        .footer { background-color: #8b0000 !important; }
        .chinese-pattern { 
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="chinese_dashboard.php">
                <i class="fas fa-utensils"></i> Chinese Dashboard - Foodie Express
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="chinese_dashboard.php">
                            <i class="fas fa-tachometer-alt me-1"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="chinese_menu.php">
                            <i class="fas fa-utensils me-1"></i> Chinese Menu
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <div class="dashboard-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2><i class="fas fa-dragon me-2"></i>Chinese Restaurant Dashboard</h2>
                    <p class="text-muted">Chinese orders summary and management</p>
                </div>
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="stats-card text-center">
                    <i class="fas fa-drumstick-bite fa-3x mb-3" style="color: #8b0000;"></i>
                    <h3><?php echo $total_orders; ?></h3>
                    <p class="text-muted mb-0">Total Chinese Orders</p>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="stats-card text-center">
            ...
            <div class="col-md-3 mb-3">
                <div class="stats-card text-center">
                    <i class="fas fa-rupee-sign fa-3x mb-3" style="color: #d4af37;"></i>
        ...
        <div class="card mb-4">
            <div class="card-header bg-white">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h4 class="mb-0"><i class="fas fa-utensils me-2"></i>Chinese Order Management</h4>
                    </div>
            ...
            <div class="card-body">
                <?php if (mysqli_num_rows($distinct_orders_result) > 0): ?>
                    <?php while ($order_row = mysqli_fetch_assoc($distinct_orders_result)): ?>
                        <?php 
                            ...
                            $order_items = getOrderDetails($conn, $order_id, $chineseRestaurant);
                            ...
                            $order_date = $order_items[0]['created_at'] ?? $order_row['created_at'];
                        ?>
                        <div class="order-card">
                            <div class="order-header">
                                <div class="row align-items-center">
                                    <div class="col-md-4">
                                        <h5 class="mb-1">Chinese Order #<?php echo htmlspecialchars($order_id); ?></h5>
                                    ...
                                    <div class="col-md-3 text-md-center my-2 my-md-0">
                                        <span class="badge status-badge status-<?php echo strtolower($current_status); ?>">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Update Chinese Order Status</h5>
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        <img src="https://cdn-icons-png.flaticon.com/512/3487/3487627.png" alt="No Orders" style="width: 80px; opacity: 0.5;" class="mb-3">
                        <h4>No Chinese Orders Found</h4>
                        <p class="text-muted">There are no Chinese food orders matching your filter criteria.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="modal fade" id="settingsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Chinese Dashboard Settings</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="">
                    <div class="modal-body">
